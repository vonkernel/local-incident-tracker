...
class AnalysisResultRepositoryAdapterTest {
    ...
    // ===== Part 11: save() 멱등성 테스트 - 기존 데이터 원자적 교체 (2개) =====

    @Test
    @DisplayName("Part 11.1: save() - 동일 articleId로 재저장 시 기존 데이터를 원자적으로 교체한다")
    ...
    @Test
    @DisplayName("Part 11.2: save() - 존재하지 않는 articleId에 대해 정상 저장된다")
